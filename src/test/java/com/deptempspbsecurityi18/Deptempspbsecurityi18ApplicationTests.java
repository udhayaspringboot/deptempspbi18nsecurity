...
import com.deptempspbsecurityi18.dao.DeptEmpDaoImpl;
...
public class Deptempspbsecurityi18ApplicationTests {
	...
	public void a_connectionCheck() {
		...
		try {
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/deptempspb", "root", "root");
	...
	/*
	 * @Test public void k_readDept() { a_connectionCheck();
	 * assertNotNull("reading department value Department", empd); try {

...
<th></th>
							...
							<c:forEach items="${deptlv}" var="dval">
									<c:if test="${deptva ne dval.deptId}">
										...
										<tr><td><input type="checkbox" name="ids"
								...
								</c:forEach><div class="pos_del"><input type="submit" value="Delete" ></div></form:form>
</tbody>
...
<%-- <c:forEach var="emp" items="${val}"> --%><form:form id = "emppagedele" action="deleteemployee" method="get"
							modelAttribute="emppage"><c:forEach var="emp" items="${val}">
									<c:if test="${empl ne emp.empId}">
										<tr>
										<td  style="width: 100px;"><input type="checkbox"
												name="idsemp" value="${emp.empId},${emp.department.deptId}" ></td>
									...
									</c:forEach><div class="pos_dele"><input type="image" value="Delete" src="delete.jpg" width="25" height="25" align="middle" ></div></form:form>
